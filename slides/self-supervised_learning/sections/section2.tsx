...
const MaskingSlide: Page = () => (
  <ContentWithImgLayout
    ...
    imageNode={
      <MaskedLanguageModelingVisualizer />
    }
    imageWidth={760}
    imageHeight={520}
  >
    ...
    >
      <li>
        BERT masks a portion of the input tokens and asks the encoder to recover the original words.
      </li>
      <li>
        The corrupted token may be replaced by <strong style={{ color: "#0a2f41" }}>[MASK]</strong>, a random token, or kept unchanged.
      </li>
      <li>
        The task forces the model to use both left and right context.
      </li>
    </ul>
...
const OutputHeadSlide: Page = () => (
  ...
  >
    ...
    >
      <li>
        Only the hidden states at masked positions are used for the reconstruction loss.
      </li>
      <li>
        The objective is a standard <strong style={{ color: "#0a2f41" }}>cross-entropy loss</strong> over the vocabulary.
      </li>
      <li>
        This makes the encoder learn <Highlight>contextual representations</Highlight> instead of static word lookup tables.
      </li>
    </ul>
  </ContentLayout>
);
